...
export class Artist {
  ...
  curve(path, primitive = "cubic", tension = 1.0) {
    this.definitions.push(buildSplineDString(path, primitive, tension));
    return this;
  }
...
export default class SVGBuilder {
  ...
  artist(stroke, fill, opacity, transform, dropShadow, gaussianBlur) {
    return new Artist(
      stroke,
      fill,
      opacity,
